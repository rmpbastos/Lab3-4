...
public class CategoryController {
    ...
    public String showCategory(ModelMap model) throws ClassNotFoundException, SQLException {
    ...
    @GetMapping(path = "/")
    public String showCategory2(ModelMap model) throws ClassNotFoundException, SQLException {
    ...
    public String showUpdate(ModelMap model, @RequestParam String catcode, @RequestParam String catdesc) throws ClassNotFoundException, SQLException {
